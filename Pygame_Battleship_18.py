...
start_img = pygame.image.load('C:\\Users\\klein\\Desktop\\Boredom\\start_btn.png')
...
def draw_grid():
    for x in range(300, CELL_SIZE*11 + 300, CELL_SIZE):
      pygame.draw.line(screen, pygame.Color("black"), (x, 50), (x, 420))
    for y in range(50, CELL_SIZE*11 + 50, CELL_SIZE):
      pygame.draw.line(screen, pygame.Color("black"), (300, y), (670, y))
      
def draw_grid_Mine():
    for x in range(10, CELL_SIZE*11 + 10, CELL_SIZE):
      pygame.draw.line(screen, pygame.Color("black"), (x, 50), (x, CELL_SIZE*11 + 13))
    for y in range(50, CELL_SIZE*11 + 50, CELL_SIZE):
      pygame.draw.line(screen, pygame.Color("black"), (10, y), (CELL_SIZE*10 +10, y))

def draw_grid_Opponet():
    for x in range(500, CELL_SIZE*11 + 500, CELL_SIZE):
      pygame.draw.line(screen, pygame.Color("black"), (x, 50), (x, CELL_SIZE*11 + 13))
    for y in range(50, CELL_SIZE*11 + 50, CELL_SIZE):
      pygame.draw.line(screen, pygame.Color("black"), (500, y), (CELL_SIZE*10 + 500, y))
...
while run:
  ...
  if start_button.draw():
    ...
    for box in EnemyColider:
      pygame.draw.rect(screen, "turquoise1", box)
  ...
  for event in pygame.event.get():
    ...
    if not PhaseTwo :
      ...
      if event.type == pygame.MOUSEMOTION:
        ...
        pygame.draw.rect(screen, "turquoise3", boardP)
        
        myboardP = pygame.Rect(0, 500, 100, 200)
        pygame.draw.rect(screen, "turquoise3", myboardP)
        ...
        for r in range(len(arr)):
            for c in range(len(arr)):
                if arr[c][r] == "■":
                    ...
                    pygame.draw.rect(screen, "purple", myShip)
                elif arr[c][r] == "X":
                    myShip = pygame.Rect(MyBoardCollisions[r*10 + c].x, MyBoardCollisions[r*10 + c].y, 37, 37)
